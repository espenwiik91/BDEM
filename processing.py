...
class Processing:
    ...
    """
        **************************************************************************************************************
        takes a csvfile and a number as arguments. Finds the numberOfWords most popular words used in tweets stored in 
        csvfile and returns a list with tuples as elements. The tuples are frequencies and words.
    """
    ...
    """
        *************************************************************************************************************
        takes a csvfile with twitter texts and a number as arguments. Finds the numberOfWords most popular combination 
        of two words in sequence (bigrams), and returns these in a list with tuples as elements. The tuples are 
        frequencies and bigrams.
    """
